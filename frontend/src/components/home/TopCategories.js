                        ...
                        <div className="position-relative">
                            ...
                            >
                                ...
                                {categories.map((category, index) => {
                                    ...
                                    const image = category.image || category.img || category.thumbnail || `https://placehold.co/400x400/333333/FFFFFF?text=${encodeURIComponent(name)}`;
                                    ...
                                    return (
                                        ...
                                        >
                                            ...
                                            <Card 
                                                className="bg-transparent border-0 h-100 shadow-lg text-white category-card-custom" 
                                                style={{ 
                                                    borderRadius: '12px', 
                            ...
                            <div className="d-none d-md-block">
                                ...
                                >
                                    <span className="slider-control-icon"><FaAngleLeft /></span>
                                </button>
                                <button 
                                ...
                                >
                                    <span className="slider-control-icon"><FaAngleRight /></span>
                                </button>
                            </div>
                        </div>
                    )}
